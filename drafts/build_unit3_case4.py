        ...
        "question": {
            ...
            "cloze": {
                ...
                "dropdowns": [
                    ...
                    dropdown(("early liver failure", False),
                             ("enzyme release from damaged skeletal muscle", True),
    ...
    {  # 6 Evaluate outcomes
        ...
        "question": {
            ...
            "cloze": {
                ...
                "dropdowns": [
                    dropdown(("curing the underlying genetic defect", False),
                             ("no longer needed because Ethan's strength has stabilized", False),
                             ("achieving its goal of slowing the loss of muscle strength", True)),
                    dropdown(("stop physical therapy until his weight improves", False),
                             ("request a dietitian referral and discuss vitamin D and calcium supplementation with the provider", True),
                             ("give extra calories to support muscle growth", False)),
                    dropdown(("can be stopped at home once his weight returns to normal", False),
                             ("should be stopped for 1 week each month to allow a steroid holiday", False),
                             ("must never be stopped suddenly; any change must be a gradual taper directed by the provider", True)),
                ],
            },
            "explanation": rationale(
